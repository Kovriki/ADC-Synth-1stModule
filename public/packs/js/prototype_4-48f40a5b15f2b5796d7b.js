...
var _jsxFileName = "/Users/polinamazitova/@Dev/ADC-Generative-Art-Boilerplate-2023/app/javascript/packs/prototype_4.js",
    _this = undefined;


 // const prototypeId = 'prototype_2'
...
function createNewOscillator() {
  ...
  oscillator.type = 'squ are';
  oscillator.frequency.setValueAtTime(440, audioCtx.currentTime); // value in hertz

  oscillator.connect(audioCtx.destination); //это подключение к колонке
...
function createSlider() {
  ...
  slider.value = 440;
  slider.id = 'slider';
  container.appendChild(slider); //вставляем в body
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  frame.addEventListener('click', function () {
    createNewOscillator();
    createSlider();
    createButton('Этой кнопке нужен текст');
    createOscillatorTypeButtons();
    ReactDOM.render( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Welcome, {
      name: "Test",
      __self: _this,
      __source: {
        fileName: _jsxFileName,
...
/******/ });
//# sourceMappingURL=prototype_4-48f40a5b15f2b5796d7b.js.map