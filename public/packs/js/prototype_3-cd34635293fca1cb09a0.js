...
document.addEventListener('DOMContentLoaded', function () {
  ...
  glass.classList.add('glass--1'); // bg.innerText = 'bg'
  // bg.classList.add('city')

  container.appendChild(textBlock);
  container.appendChild(glass); // container.appendChild(bg)
});

/***/ })

/******/ });
//# sourceMappingURL=prototype_3-cd34635293fca1cb09a0.js.map