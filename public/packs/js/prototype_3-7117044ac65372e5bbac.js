...
document.addEventListener('DOMContentLoaded', function () {
  ...
  textBlock.classList.add('textBlock'); // bg.innerText = 'bg'
  // bg.classList.add('city')

  container.appendChild(textBlock); // container.appendChild(bg)
});

/***/ })

/******/ });
//# sourceMappingURL=prototype_3-7117044ac65372e5bbac.js.map